...
def loadrsdtoas(idir, lStoN=False, nlats=nlats):
    ...
    for month in np.arange(1, 13):
        ...
        ans = round(latrange/nlats, 2)
        ifile = 'dlat'+str(ans)+'month'+('0' if month < 10 else '')+str(month)+('.StoN' if lStoN else '.NtoS')+'.npy'

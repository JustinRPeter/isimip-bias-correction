...
;      CT, VIS, Aug 2013: IDL-68771: Only allow non-fixed parameters to change.
;
;-
FUNCTION CURVEFIT, x, y, weightsIn, a, sigma, FUNCTION_NAME = Function_Name, $
  ...
  weights = noWeighting ? REPLICATE(1.0, nY) : REFORM(weightsIn)
  ...
  FOR iter = 1, itmax DO BEGIN      ; Iteration loop
    ...
    ; Save new parameter estimates (only the ones that are non-fixed).
    a[iparam] = b[iparam]
